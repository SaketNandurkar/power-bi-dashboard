// Professional SVG Icon Library for Enterprise Dashboard
import React from 'react';

export const UploadIcon = ({ size = 20, color = "currentColor" }) => (
...
export const SyncIcon = ({ size = 20, color = "currentColor", spinning = false }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const DatabaseIcon = ({ size = 20, color = "currentColor" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const AlertCircleIcon = ({ size = 20, color = "currentColor" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const SettingsIcon = ({ size = 20, color = "currentColor" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M12 1v6m0 6v6m5.2-13.2l-4.24 4.24m-2.83 2.83L5.8 17.2M23 12h-6m-6 0H1m17.2-5.2l-4.24 4.24m-2.83 2.83L5.8 6.8" />
  </svg>
);
